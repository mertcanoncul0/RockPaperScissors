      ...
      >
        <CardBody className="mb-6">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            >
              <button
                className="rounded-lg bg-[#BCCED9] hover:bg-[#6395B8] transition-colors cursor-not-allowed text-2xl font-bold text-white w-full px-18 py-2"
            ...
            <button
              className="rounded-lg bg-button-gradient text-2xl font-bold text-white w-full px-18 py-2"
              aria-label="Çevrim dışı"
            >
              Çevrim dışı
            </button>
          </div>
          ...
          <div
            ...
            aria-label="Oyun hareketleri genel"
          >
            <button
              onClick={() =>
                setOptions({
            ...
            <button
              aria-label="Oyun hareketleri ekstra"
              onClick={() =>
                setOptions({
                  ...options,
